...
@class ThinkDoctor_UnderlineRenderer;
@class ThinkDoctor_CustomFrameRenderer;
@class ThinkDoctor_IconViewRenderer;
@class Xamarin_Forms_Platform_iOS_ScrollViewRenderer;
@class ThinkDoctor_MyScrollRender;
@class Xamarin_Forms_Platform_iOS_ImageRenderer;
@class ThinkDoctor_iOS_RoundImageRenderer;
@class ThinkDoctor_iOS_PDFItem;
@class ThinkDoctor_iOS_PDFPreviewControllerDataSource;
@class Xamarin_Forms_Platform_iOS_PageRenderer;
@class Thinkdocotor_iOS_Renderer_GradientPageRenderer;
@class Xamarin_Forms_Platform_iOS_EntryRenderer;
@class ThinkDoctor_MyEntryRenderer;
@class ThinkDoctor_iOS_FilePickerImplementation;
@class Xamarin_Forms_Platform_iOS_FormsApplicationDelegate;
@class AppDelegate;
@class Thinkdocotor_iOS_Renderer_DropDownMenuRender_iOS;
...
@class Messier16_Forms_iOS_Controls_CheckboxRenderer;
@class Messier16_Forms_iOS_Controls_RatingBarRenderer;
@class Messier16_Forms_iOS_Controls_SegmentedControlRenderer;
@class Messier16_Forms_iOS_Controls_Native_Checkbox_Checkbox;
@class Messier16_Forms_iOS_Controls_Native_RatingBar_EDStarRating;
...
@interface ThinkDoctor_UnderlineRenderer : Xamarin_Forms_Platform_iOS_LabelRenderer {
}
	-(id) init;
@end

@interface ThinkDoctor_CustomFrameRenderer : Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 {
}
	-(id) init;
@end

@interface ThinkDoctor_IconViewRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end
...
@interface ThinkDoctor_MyScrollRender : Xamarin_Forms_Platform_iOS_ScrollViewRenderer {
}
	-(id) init;
@end
...
@interface ThinkDoctor_iOS_RoundImageRenderer : Xamarin_Forms_Platform_iOS_ImageRenderer {
}
	-(id) init;
@end

@interface ThinkDoctor_iOS_PDFItem : NSObject<QLPreviewItem> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface ThinkDoctor_iOS_PDFPreviewControllerDataSource : NSObject<QLPreviewControllerDataSource> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Thinkdocotor_iOS_Renderer_GradientPageRenderer : Xamarin_Forms_Platform_iOS_PageRenderer {
}
	-(id) init;
@end
...
@interface ThinkDoctor_MyEntryRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end

@interface ThinkDoctor_iOS_FilePickerImplementation : NSObject<UIDocumentMenuDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Thinkdocotor_iOS_Renderer_DropDownMenuRender_iOS : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(CGRect) frame;
...
@interface Messier16_Forms_iOS_Controls_CheckboxRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end

@interface Messier16_Forms_iOS_Controls_RatingBarRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end

@interface Messier16_Forms_iOS_Controls_SegmentedControlRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end

@interface Messier16_Forms_iOS_Controls_Native_Checkbox_Checkbox : UIControl {
}
	@property (nonatomic, assign) float CheckLineWidth;
	@property (nonatomic, assign) UIColor * CheckColor;
	@property (nonatomic, assign) float ContainerLineWidth;
	@property (nonatomic, assign) UIColor * CheckboxBackgroundColor;
	@property (nonatomic, assign) BOOL FillsOnChecked;
...
@interface Messier16_Forms_iOS_Controls_Native_RatingBar_EDStarRating : UIControl {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
