...
{
    public class AddRoom : PopupPage
    {
        ...
        List<string> ls1;
        public AddRoom(consulting_venues consultingvenue,List<string> ls)
        {
            ls1 = ls;
            cv =consultingvenue;
        ...
        async void btncontinue_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var json = JsonConvert.SerializeObject(consulting_room);
                ...
                else
                {
                    ...
                    await DisplayAlert("", "Add room error try again", "Ok");
                    return;
                }
