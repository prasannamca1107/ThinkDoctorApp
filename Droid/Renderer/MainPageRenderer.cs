...
using Thinkdocotor.Droid.Renderers;
...
namespace Thinkdocotor.Droid.Renderers
{
    internal class MainPageRenderer : VisualElementRenderer<TabbedPage>, IOnTabClickListener
    {
        ...
        private void InitializeElement(TabbedPage element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(TabbedPage element)
        {
        ...
        private void ClearElement(TabbedPage element)
        {
            if (_currentPage != null)
            {
