...
[global::Android.Runtime.Preserve(AllMembers = true)]
	public class FilePickerImplementation : IFilePicker
	{
		...
		public async Task<bool> SaveFile(FileData fileToSave)
		{
			try
			{
				File myFile = new File(global::Android.OS.Environment.ExternalStorageDirectory, fileToSave.FileName);
		...
		{
			var uri = global::Android.Net.Uri.FromFile(fileToOpen);
		...
		{
			File myFile = new File(global::Android.OS.Environment.ExternalStorageState, fileToOpen);
		...
		{
			File myFile = new File(global::Android.OS.Environment.ExternalStorageState, fileToOpen.FileName);
